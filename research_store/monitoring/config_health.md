...
| manual_fill_validation | ERROR | WARNING | issues=3 | research_store\reports\manual_fill_validation.json |
| execution_day_end | BLOCKED | WARNING | status=BLOCKED | research_store\reports\execution_day_end.json |
