"""Fetch CSI 300 stock data using mootdx (faster, no rate limit)."""
...
def main() -> None:
    ...
    for i, symbol in enumerate(stocks):
        try:
            ...
            # mootdx returns most recent data first
            df = client.bars(symbol=symbol, frequency=9, offset=800)  # ~3 years of daily data
